...
/*   Updated: 2021/07/02 20:21:05 by youness          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_backtrack_step(t_stack *src, t_path *path, t_case *state, int depth)
{
	int			i;
	int			error;
	t_stack		*tmp;
...
int	ft_backtrack_atomic_case(t_stack *src, t_path *path, t_case *state, int depth)
{
	t_path		*new_path;
	t_solution	*solution;
